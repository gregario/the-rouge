  ...
  return (
    <div className={styles.controls} role="group" aria-label="Timer controls">
      <div className={styles.buttonGroup}>
        ...
        <span className={styles.shortcutHint} aria-hidden="true" data-testid="shortcut-hint-r">R</span>
      </div>
      ...
      <div className={styles.buttonGroup}>
        ...
        <span className={styles.shortcutHint} aria-hidden="true" data-testid="shortcut-hint-space">Space</span>
      </div>
      ...
      <div className={styles.buttonGroup}>
        ...
        <span className={styles.shortcutHint} aria-hidden="true" data-testid="shortcut-hint-s">S</span>
      </div>
    </div>
  );
}
