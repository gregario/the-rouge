...
| _next_ | P1.19 PR 12 — seeding/07-marketing.md modernization (eight Writing Rules + no-fabricated-proof integrity rule + 4-artifact contract preserved; "think deeply" scaffolding removed; 22 tests) |
