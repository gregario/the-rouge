...
- **P1.5R continued** (in progress) — PR 3 (SIZING sub-phase), PR 4 (swarm orchestrator skip-by-tier), PR 5 (SPEC tier-aware depth), PR 6 (budget/cycle defaults by tier). See `docs/design/adaptive-depth-dial.md` §Implementation plan.
