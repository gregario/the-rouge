...
- **P1.5R PR 6** (last in this initiative) — budget cap + cycle-budget defaults read `project_size` (XS ~$15 / S ~$30 / M ~$50 / L ~$100 / XL ~$250 per the design doc). Governance log records (tier, actual-spend) pair per project for later empirical recalibration.
